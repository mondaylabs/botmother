...
class BotRouter:
    ...
    def command(self, command, function, last_action=None, chat_type=None, edited=False, reply_type=None):
        ...
        if self.message.text == command:
            self.run(function, last_action, chat_type, edited, reply_type)

    def starts_with(self, prefix, function, last_action=None, chat_type=None, edited=False, reply_type=None):
        """ Routes text type webhook that starts with given prefix """
        text = self.message.text
        if type(text) == str and text.startswith(prefix):
            self.run(function, last_action, chat_type, edited, reply_type)

    def text(self, text, function, last_action=None, chat_type=None, edited=False, reply_type=None):
    ...
    def callback(self, prefix, function, last_action=None, chat_type=None, edited=False, reply_type=None):
    ...
    def location(self, function, last_action=None, chat_type=None, edited=False, reply_type=None):
        """ Routes location type webhook to handlers """
        if self.type == Message.TYPE_LOCATION:
            self.run(function, last_action, chat_type, edited, reply_type)

    def contact(self, function, last_action=None, chat_type=None, edited=False, reply_type=None):
        """ Routes contact type webhook to handlers """
        if self.type == Message.TYPE_CONTACT:
            self.run(function, last_action, chat_type, edited, reply_type)

    def new_photo(self, function, last_action=None, chat_type=None, edited=False, reply_type=None):
        """ Routes to handlers when you add group photo """
        if self.type == Message.TYPE_NEW_CHAT_PHOTO:
            self.run(function, last_action, chat_type, edited, reply_type)

    def any(self, function, last_action=None, chat_type=None, edited=False, reply_type=None):
        """ Routes any type of webhook request """
        self.run(function, last_action, chat_type, edited, reply_type)

    def on_checkout_query(self, function, last_action=None, chat_type=None, edited=False, reply_type=None):
        """ Routes pre_checkout_query type of webhook request """
        if self.pre_checkout_query:
            self.run(function, last_action, chat_type, edited, reply_type)

    def run(self, function, last_action=None, chat_type=None, edited=False, reply_type=None):
        ...
        handler_type = self.type if self.type else 'Unknown Type'
        ...
        self.runned = not result

        if self.runned:
            print(f'RUNNING HANDLER: {(self.redirect_action or function).__name__} TYPE: {handler_type}')
